...
<!-- Form start  -->
<div class="container">
    <h4>Employee Reference Information Edit</h4>
    <hr />
    <form class="form-horizontal" method="post" action="" >
        ...
        <div class="form-group"> 
            <div class="col-sm-offset-2 col-sm-9">
                ...
                <button class="btn btn-active" name="cencel" id="cencel"><a href="emp_reference_info.php" style="text-decoration:none">Cencel</a></button>
            </div>
        </div>
    </form>
</div>
